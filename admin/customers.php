        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="p-8">
                <div class="bg-white rounded-xl shadow-sm p-12 text-center">
                    ...
                    <h2 class="text-2xl font-semibold text-gray-900 mb-4">Customer Management</h2>
                    <p class="text-gray-600 mb-6">This feature is coming soon. You'll be able to view and manage customer accounts, order history, and more.</p>
